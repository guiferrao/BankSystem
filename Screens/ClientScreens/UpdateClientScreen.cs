...
{
    public static class UpdateClientScreen
    {
        public static void Load()
        {
            ...
            Console.WriteLine("------------------");
            Console.WriteLine();
            Console.WriteLine("Atualizar cliente do Banco");
            Console.WriteLine("----------------------");
            Console.WriteLine("Qual Id do cliente a atualizar: ");
        ...
        public static void Update(Clientes clientes)
        {
            try
            {
                ...
                repository.Update(clientes);
                Console.WriteLine("Cliente atualizado no banco");
            }
            catch (Exception ex)
            {
                Console.WriteLine("Não foi possivel atualizar o cliente");
